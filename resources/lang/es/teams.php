...
return [
    "create_team" => "Crear Finca",
    "team_name" => " Nombre de Finca",
    "team_slug" => "Finca Slug",
    "team_members" => "Miembros de la Finca",
    ...
    "team" => " Finca",
    "update_team_name" => "Actualizar nombre de la finca",
    "team_name_was_updated" => " Your team name has been updated!",
    "current_teams" => " Fincas Actuales",
    "leave_team" => " Dejar Finca",
    "are_you_sure_you_want_to_leave_team" => "Estas seguro que quieres abandonar la finca?",
    "delete_team" => " Eliminar Finca",
    "are_you_sure_you_want_to_delete_team" => "Estas seguro que quieres eliminar la finca?",
    "if_you_delete_team_all_data_will_be_deleted" => "If you choose to delete the team all data will be permanently deleted.",
    "team_photo" => " Foto de Finca",
    "edit_team_member" => " Editar miembro",
    ...
    "team_settings" => "Configuracion de la Finca",
    ...
    "wheres_your_team" => "No tienes ninguna Finca.",
    "looks_like_you_are_not_part_of_team" => "¿Deseas crear una finca?",
