        ...
        <div class=" " id="feed_table" style="overflow: hidden;">
            ...
            <div class="pull-right search mb-2">
                <button type="button" id="addfood" class="btn btn-info ml-5" data-toggle="modal"
                    data-target="#addSowingModal"><i class="fa fa-plus" aria-hidden="true"></i> Añadir Alimento</button>
            </div>
...
<div class="card-body">
   <div class="row mx-auto"> 
    ...
    <div class="modal fade" id="addSowingModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
